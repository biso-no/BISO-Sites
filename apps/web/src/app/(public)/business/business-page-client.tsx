                        ...
                        {benefits.map((benefit, index) => {
                            ...
                            return (
                                ...
                                >
                                    <Card
                                        className={cn(
                                            "h-full border-0 bg-linear-to-br p-6 shadow-lg transition-all hover:shadow-xl hover:-translate-y-1",
                                            colors.gradient,
                                            colors.border
                                        )}
                                    >
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {careerDays.map((career, index) => (
                            <motion.div
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                            >
                                <Card className="group h-full overflow-hidden border-0 bg-card p-6 shadow-lg transition-all hover:shadow-xl hover:-translate-y-1">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {campuses.map((campus, index) => (
                            <motion.div
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                            >
                                <Card className="group h-full border-0 bg-card p-6 shadow-lg transition-all hover:shadow-xl hover:-translate-y-1">
                                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-brand-gradient-from to-brand-gradient-to shadow-md">

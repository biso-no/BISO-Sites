...
export function UploadStep({ onNext, onBack }: UploadStepProps) {
 ...
 <div className="cursor-pointer rounded-lg border-2 border-brand-border-strong border-dashed p-12 text-center transition-all hover:border-brand hover:bg-brand-muted">
 ...
 {/* Total */}
 <Card className="border-brand-border bg-brand-muted p-4">
 <div className="flex items-center justify-between">

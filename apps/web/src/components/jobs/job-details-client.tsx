...
export function JobDetailsClient({ job }: JobDetailsClientProps) {
 ...
 <div className="rounded-lg bg-brand-muted px-3 py-1">
 <span className="text-brand-dark text-sm">{department}</span>
 </div>
 </div>
 ...
 <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-linear-to-r from-brand-gradient-from to-brand-gradient-to font-bold text-white">
 1
 </div>
 <div>

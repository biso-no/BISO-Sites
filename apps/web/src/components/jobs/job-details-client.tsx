...
export function JobDetailsClient({
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero header */}
      <section className="bg-linear-to-br from-brand-overlay-from via-brand-overlay-via to-brand-overlay-to">
        <div className="mx-auto max-w-6xl px-4 pt-32 pb-16">
          ...
          <div className="max-w-3xl space-y-4">
            <Badge className="border-white/30 bg-white/10 text-white/90">
              {employmentType}
            </Badge>

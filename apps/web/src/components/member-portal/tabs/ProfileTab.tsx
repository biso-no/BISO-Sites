...
import { Eye, EyeOff, Check, Linkedin, Twitter, Facebook } from 'lucide-react'
...
import type { Users, PublicProfiles } from '@repo/api/types/appwrite'
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">{t('publicProfileDescription')}</p>
            </div>
          </div>
          <Switch 

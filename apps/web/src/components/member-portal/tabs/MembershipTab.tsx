...
import { Check, Sparkles, Download, Smartphone, Share2 } from 'lucide-react'
      ...
      <Card className="p-8 border-0 shadow-lg dark:bg-gray-900/50 dark:backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">{t('nextBillingDate')}</div>
            <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('upgradeMembership')}</h3>
          ...
          {Object.entries(MEMBERSHIP_PRICES).map(([type, price]) => (
            ...
            >
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">{price} NOK</div>
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('digitalCard')}</h3>

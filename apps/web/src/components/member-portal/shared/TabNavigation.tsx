...
import { Sparkles, User, Shield, Gift, Settings } from 'lucide-react'
...
export function TabNavigation({ defaultTab = 'overview', benefitsCount, isMember, hasBIIdentity, children }: TabNavigationProps) {
  ...
  useEffect(() => {
    ...
    const handleHashChange = () => {
      ...
      if (newHash && ['overview', 'profile', 'membership', 'benefits', 'settings'].includes(newHash)) {

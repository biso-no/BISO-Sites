...
import { Lock, CreditCard, LinkIcon } from 'lucide-react'
                  ...
                  {Object.entries(MEMBERSHIP_PRICES).map(([type, price]) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{price} NOK</div>
                        {type === 'three-year' && (
                          <Badge variant="outline" className="mt-2 border-[#3DA9E0]/20 dark:border-[#3DA9E0]/30 text-[#3DA9E0] text-xs">

...
import { formatPrice, getDisplayPrice, calculateSavings } from '@/lib/types/webshop'
          ...
          <div className="mb-6">
            {hasDiscount ? (
              <div className="flex items-center gap-2">
                <span className="text-gray-400 line-through text-lg">{formatPrice(productData.regular_price)}</span>
                <span className="text-[#3DA9E0] text-xl font-bold">{formatPrice(displayPrice)}</span>
              </div>
            ) : (

...
const categoryColors: Record<string, string> = {
 ...
 "Student Life": "bg-brand-muted text-brand-dark border-brand-border",
 Achievements: "bg-cyan-100 text-brand-dark border-cyan-200",
...
export function ArticleCard({ article, variant, index = 0 }: ArticleCardProps) {
 ...
 <Button
 className="group h-auto self-start p-0 text-brand-dark hover:text-brand"
 variant="ghost"
 >
 Read More
 <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />

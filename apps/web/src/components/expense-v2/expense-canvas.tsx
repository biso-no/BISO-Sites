      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-4 border-white/20 bg-white/10 backdrop-blur-sm">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <Card className="border-white/20 bg-white/10 px-4 py-2 backdrop-blur-sm">
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      {features.map((feature, index) => (
        ...
        >
          <Card className="border-primary/10 bg-white p-4 transition-all hover:border-primary/20 hover:shadow-md dark:bg-gray-900">
                ...
                {canProceedToAssign && (
                  <>
                    ...
                    {profile.bank_account && (
                      <Card className="border-primary/10 bg-white p-4 dark:bg-gray-900">

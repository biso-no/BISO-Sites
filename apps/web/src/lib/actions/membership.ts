...
async function fetchMembershipFromFinago(): Promise<MembershipStatus> {
    ...
    try {
        ...
        try {
            ...
            console.log(`[Membership] Finago category IDs for ${numericId}:`, finagoCategoryIds);
        } catch (error) {

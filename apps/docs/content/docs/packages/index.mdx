...
AI-powered features using the Vercel AI SDK for intelligent assistants and form automation.

**Key Features:**
- Streaming AI chat interfaces
- Navigation tools for AI-guided workflows
- Form autopilot for AI-assisted data entry
- Shared prompts and configuration

[View AI Documentation →](/docs/packages/ai/overview)
...
- Explore [AI Package](/docs/packages/ai/overview) for intelligent assistants

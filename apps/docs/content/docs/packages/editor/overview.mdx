...
- 📦 **Pre-built Components** - Button, Heading, Section, Text
...
<Callout type="info">
  ...
  - [Admin App Guide](/docs/apps/admin) - Using the admin interface
  - [Content Management](/docs/guides/creating-features) - Managing content
</Callout>

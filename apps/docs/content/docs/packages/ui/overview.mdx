...
| Surface | Usage |
|---------|-------|
| [Web App components](/docs/applications/web-app/components) | Marketing pages, forms, cards, layout |
| [Admin App dashboards](/docs/applications/admin-app/index) | Tables, filters, navigation, dialogs |
| [Docs architecture](/docs/architecture/apps#docs-application) | Callouts, tabs, and MDX UI primitives |
...
- [Styling Guide](/docs/development/guides/styling-conventions) - BISO Sites styling patterns
- [Forms Guide](/docs/development/guides/forms) - Building forms with these components

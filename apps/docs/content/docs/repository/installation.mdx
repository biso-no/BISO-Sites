...
<Callout type="info" title="Detailed Appwrite Setup">
  For complete Appwrite database schema and configuration, see [Appwrite Setup](/docs/operations/appwrite-setup).
</Callout>
...
3. **Start Developing** - [Development Workflow](/docs/development/guides/development-workflow)
4. **Build a Feature** - [Creating Features](/docs/development/guides/creating-features)

<Callout type="success" title="Successfully Installed!">
  You're all set! Head to the [Development Workflow](/docs/development/guides/development-workflow) to learn about day-to-day development.
</Callout>

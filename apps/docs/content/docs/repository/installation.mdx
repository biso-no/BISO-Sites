...
Before installing MON, ensure you have these tools installed:
...
<Steps>
  <Step title="Clone the Repository">
    ...
    ```bash
    git clone <your-repository-url> mon
    cd mon
    ```
...
MON uses Appwrite as its backend. You have two options:

...
Understanding how data moves through the system is crucial for building features and debugging issues. This document explains the various data flow patterns used in MON.

## Data Flow Patterns

MON uses different patterns depending on the operation type:
...
<Callout type="info" title="Related Documentation">
  ...
  - [Development Workflow](/docs/guides/development-workflow) - Building features
</Callout>

...
<FileTree>
  <FileTreeItem name="apps/web/" icon="📁">
    ...
    <FileTreeItem name="public/" icon="📁" depth={1}>
      <FileTreeItem name="images/" icon="📁" depth={2} />
    </FileTreeItem>
    ...
    <FileTreeItem name="tailwind.config.cjs" icon="⚙️" depth={1} />
    <FileTreeItem name="tsconfig.json" icon="⚙️" depth={1} />
  </FileTreeItem>
</FileTree>

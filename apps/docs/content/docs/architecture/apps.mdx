...
<Callout type="info">
  For detailed web app development, see [Web App Documentation](/docs/applications/web-app).
</Callout>
...
<Callout type="info">
  For detailed admin app development, see [Admin App Documentation](/docs/applications/admin-app).
</Callout>
...
- [Web App Deep Dive](/docs/applications/web-app)
- [Admin App Deep Dive](/docs/applications/admin-app)

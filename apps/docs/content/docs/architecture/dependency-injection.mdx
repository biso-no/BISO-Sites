...
<Callout type="info" title="Apply This Pattern">
  ...
  - [Development Guides](/docs/development/guides/creating-features) - Apply when building features
  - [Testing Guide](/docs/development/guides/testing) - Learn to test with DI
</Callout>

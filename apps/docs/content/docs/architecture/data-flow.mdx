...
<Callout type="info" title="Big picture first">
  For diagrams of the whole system and layer boundaries, start with <Link href="/docs/architecture/overview">Architecture overview</Link>. This page goes deeper on **how requests and mutations move through Next.js, packages, and Appwrite**.
</Callout>

...
<FileTree>
  <FileTreeItem name="components/" icon="📁">
    <FileTreeItem name="layout/ - Header, footer, navigation" icon="📁" depth={1} />
    <FileTreeItem name="home/ - Homepage components" icon="📁" depth={1} />
    <FileTreeItem name="events/ - Event-related components" icon="📁" depth={1} />
    <FileTreeItem name="shop/ - E-commerce components" icon="📁" depth={1} />
    <FileTreeItem name="jobs/ - Job board components" icon="📁" depth={1} />
    <FileTreeItem name="news/ - News/press components" icon="📁" depth={1} />
    <FileTreeItem name="profile/ - User profile components" icon="📁" depth={1} />
    <FileTreeItem name="expense/ - Expense system components" icon="📁" depth={1} />
    <FileTreeItem name="ai/ - AI assistant components" icon="📁" depth={1} />
    <FileTreeItem name="context/ - React Context providers" icon="📁" depth={1} />
    <FileTreeItem name="locale-switcher.tsx - Language switcher" icon="📄" depth={1} />
    <FileTreeItem name="privacy-controls.tsx - GDPR controls" icon="📄" depth={1} />
  </FileTreeItem>
</FileTree>
...
- [Routing](/docs/web-app/routing) - Page structure
...
- Learn about [server actions](/docs/web-app/server-actions)
- Explore [feature implementations](/docs/web-app/features/membership)

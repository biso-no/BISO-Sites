...
<FileTree>
  <FileTreeItem name="app/" icon="📁">
    <FileTreeItem name="(public)/" icon="📁" depth={1}>
      <FileTreeItem name="page.tsx - Homepage" icon="📄" depth={2} />
      <FileTreeItem name="about/" icon="📁" depth={2} />
      <FileTreeItem name="events/" icon="📁" depth={2} />
      <FileTreeItem name="shop/" icon="📁" depth={2} />
      <FileTreeItem name="units/" icon="📁" depth={2} />
      <FileTreeItem name="membership/" icon="📁" depth={2} />
    </FileTreeItem>
    <FileTreeItem name="(protected)/" icon="📁" depth={1}>
      <FileTreeItem name="profile/" icon="📁" depth={2} />
      <FileTreeItem name="fs/ - Expense system" icon="📁" depth={2} />
    </FileTreeItem>
    <FileTreeItem name="(auth)/" icon="📁" depth={1}>
      <FileTreeItem name="auth/login/" icon="📁" depth={2} />
      <FileTreeItem name="auth/callback/" icon="📁" depth={2} />
    </FileTreeItem>

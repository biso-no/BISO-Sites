...
export const NAV_ACCESS = {
    ...
    pages: [ROLES.GLOBAL_ADMIN, ROLES.PR, DEPARTMENT_ROLE],
    posts: [ROLES.GLOBAL_ADMIN, ROLES.PR, DEPARTMENT_ROLE],
    ...
    jobs: [ROLES.GLOBAL_ADMIN, ROLES.HR, ROLES.PR, DEPARTMENT_ROLE],
    jobsApplications: [ROLES.GLOBAL_ADMIN, ROLES.HR, ROLES.PR],
    events: [ROLES.GLOBAL_ADMIN, ROLES.PR, DEPARTMENT_ROLE],
    eventsNew: [ROLES.GLOBAL_ADMIN, ROLES.PR, DEPARTMENT_ROLE],
    units: [ROLES.GLOBAL_ADMIN, ROLES.HR, ROLES.FINANCE, ROLES.PR],
    users: [ROLES.GLOBAL_ADMIN, ROLES.HR, ROLES.FINANCE],
...
export function hasNavAccess(
    ...
    for (const role of requiredRoles) {
        if (role === DEPARTMENT_ROLE) {
            if (hasDepartmentMembership) return true;

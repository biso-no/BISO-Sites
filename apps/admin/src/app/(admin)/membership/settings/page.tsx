import { getMembershipSettings, type MembershipSettingsItem } from "@/app/actions/membership-settings";
...
export default async function SettingsPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="font-bold text-2xl tracking-tight">Membership Settings</h1>

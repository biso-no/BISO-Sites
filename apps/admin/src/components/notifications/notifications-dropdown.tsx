...
import { Bell, CheckCircle, AlertCircle, Info, XCircle, Clock, Check } from 'lucide-react'
...
export function NotificationsDropdown() {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent align="end" className="w-[420px] rounded-2xl border border-primary/10 dark:border-primary/20 bg-white/95 dark:bg-card/95 backdrop-blur-xl shadow-[0_25px_50px_-20px_rgba(0,23,49,0.5)]">

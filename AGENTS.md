...
Before any Next.js work, find and read the relevant doc in `apps/{app_name}/node_modules/next/dist/docs/`. Your training data is outdated — the docs are the source of truth.

...
const pageCreationSchema = z.object({
  ...
  slug: z
    .string()
    .describe("URL-friendly slug for the page (e.g., 'terms-of-service')"),
...
export function createPageCreatorTool() {
  return tool({
    description:
      "Navigate to the new page editor with pre-filled values. The page is NOT saved to the database until the user clicks Save or Publish. Use this when the user wants to create a new page.",

  ...
  switch (type) {
    case "hero":
      return {
        ...
        variant: "split",
        eyebrow: "Eyebrow",
        title: "A headline that earns the size.",
        subtitle: "One sentence about what your unit does.",
    ...
    case "text":
      return {
        ...
        body: [
          ...
          { type: "p", text: "Tell the story like you'd tell a friend." },
        ],
      };
    case "quote":
      return {
        id,
        type,
        text: "Drop a line worth standing on its own.",
        author: "Someone",
        role: "Their role",
      };
    case "team":
    ...
    case "events":
      return {
        ...
        source: "auto",
        items: [
          { date: "Soon", title: "Event title", where: "Where", going: 0 },
        ],
      };
    case "faq":
      return {
        ...
        type,
        heading: "Questions",
        items: [{ q: "A question", a: "An answer." }],
      };
    case "contact":
      return {
        id,
    ...
    case "image":
      return { id, type, caption: "", aspect: "16/9" };
    case "gallery":
    ...
    case "marquee":
      return {
        id,
        type,
        text: "Tuesdays · Tromsø · Glögg · Buddies · Welcome week",
      };
    case "timeline":
      return {
        id,
    ...
    case "news":
      return { id, type, heading: "Latest news" };
    case "jobs":
      return { id, type, heading: "Open roles" };
    case "featureGrid":
      return {
        id,
        type,
        ...
        items: [
          {
            icon: "★",
            title: "Feature one",
            body: "Describe this benefit in one sentence.",
          },
          {
            icon: "◆",
            title: "Feature two",
    ...
    case "partners":
      return { id, type, heading: "Our partners", source: "auto" };
    case "linkTileGrid":
      return {
        id,
        type,
    ...
    case "campusSelector":
      return { id, type, mode: "cards", heading: "Choose your campus" };
    case "stepGrid":
      return {
        id,
        type,
        ...
        items: [
          {
            number: "01",
            title: "First step",
            body: "Describe the first step.",
          },
          {
            number: "02",
            title: "Second step",
            body: "Describe the second step.",
          },
          {
            number: "03",
            title: "Third step",
            body: "Describe the third step.",
          },
        ],
      };
    case "scrollRow":
    ...
    case "productGrid":
      return { id, type, heading: "Shop", source: "auto" };
    case "filterBar":
      return { id, type, target: "news" };
    case "profileHeader":
      return {
        id,
        type,
    ...
    case "multiStepForm":
      return {
        ...
        submitTarget: { collection: "submissions" },
        steps: [
          {
            title: "Your message",
            fields: [
...
export function setProp(
  ...
  const block = doc.blocks.find((b) => b.id === id) as unknown as Record<
    string,
    unknown
  >;
  if (!block) {
...
export function setVariant(doc: PageDoc, id: string, variant: string): void {
  const block = doc.blocks.find((b) => b.id === id) as
...
export function setMeta<K extends keyof PageMeta>(
  doc: PageDoc,
  key: K,
  value: PageMeta[K]
): void {
